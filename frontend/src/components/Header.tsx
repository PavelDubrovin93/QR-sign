...
function Header() {
    ...
    //   spans.forEach(span => {
    //     if (span.textContent === "Сканировать" || span.textContent === "Мои задачи" || span.textContent === "Профиль") {
    ...
    return (
      <>
        <SegmentedControl style={telegramData?.colorScheme === "dark" ? 
          ...
          <SegmentedControl.Item
            ...
            selected={selected === 0}
            style={telegramData?.colorScheme === "dark" ? { backgroundColor:  (selected === 0) ? telegramData?.themeParams.header_bg_color 
          ...
          <SegmentedControl.Item
            onClick={() => [setSelected(1), navigate("/profile")]}
            selected={selected === 1}
            style={telegramData?.colorScheme === "dark" ? { backgroundColor:  (selected === 1) ? telegramData?.themeParams.header_bg_color 
                   : telegramData?.themeParams.section_bg_color } 
                   : {}}
          >
            Профиль
