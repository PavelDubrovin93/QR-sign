...
from app.infrastructure.interfaces.services.ICompanyService import \
    ICompanyService
...
class CompanyService(ICompanyService):
    ...
    async def get_all_users_in_company_and_uc_id(
        ...
        user_companies = await self.uc_repo.get_all_users_in_company_with_company_id(
            company_id=company_id
        )
        users = [
            await self.user_repo.get_user_by_id(uc.user_id) for uc in user_companies
        ]
