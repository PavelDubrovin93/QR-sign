...
class IUISettingsRepository(ABC):
    ...
    @abstractmethod
    async def get_ui_settings_by_user_id(self, user_id: int) -> Optional[UISetting]:
        """
    ...
    @abstractmethod
    async def create_ui_settings(self, settings_data: dict) -> UISetting:
        """
